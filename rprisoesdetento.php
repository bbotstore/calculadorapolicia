            ...
            <div class="col-lg-6 col-7">
               ...
               <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                  <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                     ...
                     <li class="breadcrumb-item active" aria-current="page">Registros Detento</li>
                  </ol>
               </nav>
            </div>
      ...
      <div class="row">
         ...
         <div class="table-responsive" id="div_printer_supplie">
                        ...
                        <div class="col-md-12 text-center">
                          <div style="margin-top: -25px !important;" class="div_user_auth_annotation"> 
                            <hr class="my-4" />
                          </div>
                        </div>
                      </div>
...
<div class="row">
            <div class="col-md-4">
              <div class="form-group">
                <label class="form-control-label" for="example3cols2Input">Nome / ID Detento</label>
                <input class="form-control" type="text" id="detento" autocomplete="off"></input><br><small class="erro_consulta_usuarios"></small>
              </div>
            </div>
            <div class="col-md-4">
              <div class="form-group">
...
<script>
   ...
   $(".relatorio_prisoes_detento").addClass("active");
   ...
   $(document.body).on('click', '.btn_buscar', function() {
      ...
      detento = $('#detento').val();
         relatorio_prisoes(detento, data_inicio, data_final)
    });
   
   
    function relatorio_prisoes(detento, data_inicio, data_final){
    ...
    $.ajax({
        ...
        url: "php/banco.php?tab=prisoes&acao=relatorio_prisoes_detento",
               ...
               $.ajax({
                  ...
                  success: function (data) {
                     ...
                     if (dados.length > 0) {
                        ...
                        const oficiais = '<b>Oficiais Presentes</b></br> 1º - ' + dados[0].primeiro +'</br>2º - ' + segundo + '</br>3º - ' + terceiro + '</br>4º - ' + quinto + '</br>5º - ' + sexto + '</br>7º - ' +setimo + '</br>8º  - ' + oitavo;
