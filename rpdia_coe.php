            ...
            <div class="col-lg-6 col-7">
               ...
               <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                  <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                     ...
                     <li class="breadcrumb-item active" aria-current="page">Relatorio Diario - C.O.E</li>
                  </ol>
               </nav>
            </div>
...
<script>
   ...
   $(".relatorio_diario_ponto_coe").addClass("active");
...
if($(this).attr('checked') == false){
   ...
   $.ajax({
          type: "POST",
          url: "php/banco.php?tab=bateponto&acao=lista_usuarios_coe",
          success: function (data) {
              if (data.resp == 'ok') {
                  html = '';
