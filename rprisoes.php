  ...
  <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
    <div class="modal-content">
      ...
      <div class="row">
                  ...
                  <div class="col-md-4"><strong><h3>Nome / ID Advogado</h3></strong> <span class="texto_adv"></span></div>
                  <div class="col-md-4"><strong><h3>Autenticação</h3></strong> <span class="texto_autenticacao"><span></div>
      </div>
      <hr>
      <div class="row">
                  <div class="col-md-4"><strong><h3>Observações / Anotações</h3></strong> <span class="texto_obs"></span></div>
      </div>
      <hr>
      <div class="row">
         <div class="col-md-4">
...
<div class="row">
            ...
            <div class="col-md-3">
              <div class="form-group">
                <label class="form-control-label" for="example3cols1Input">Filtro de Pesquisa</label>
                <form><select class="form-control" id="filtro_pesquisa_prisao">
                <option value="0">Todos</option>
                <option value="1">CL - Combat Logging</option>
                </select></form><br>
              </div>
            </div>
...
<script>
   ...
   $(document.body).on('click', '.btn_buscar', function() {
      ...
      passaporte = $('#passaporte :selected').val()
      var options = document.getElementById('filtro_pesquisa_prisao').selectedOptions;
      var cl_prisao = Array.from(options).map(({ value }) => value);
      relatorio_prisoes(passaporte, data_inicio, data_final, cl_prisao)
    });
   
   
    function relatorio_prisoes(passaporte, data_inicio, data_final, cl_prisao){
    ...
    $.ajax({
        ...
        url: "php/banco.php?tab=prisoes&acao=relatorio_prisoes",
                     ...
                     if (dados.length > 0) {
                        ...
                        artigos_ = artigos.replace(new RegExp('\r?\n','g'), '</br>');
                         ...
                         if(dados[0].segundo === null ){
                           ...
                           if(dados[0].advogado === null ){
                              adv_ = 'Não';
                           } else {
                              adv_ = dados[0].advogado
                           }
                           if(dados[0].obs1 === null){
                              obs1_ = 'Não';
                           } else {
                              obs1_ = dados[0].obs1
                           }
