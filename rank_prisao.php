            ...
            <div class="col-lg-6 col-7">
               ...
               <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                  <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                     ...
                     <li class="breadcrumb-item active" aria-current="page">Relatorio Rank - Prisões</li>
                  </ol>
               </nav>
            </div>
...
<script>
   ...
   $(".relatorio_rank_prisao").addClass("active");
   ...
   function relatorio_datas(dt_inicio, dt_final, guarnicao, quantidade_registro){
    ...
    $.ajax({
        ...
        url: "php/banco.php?tab=rank&acao=prisao",
         ...
         if (data.resp == 'ok') {
            ...
            if (dados.length > 0) {
               $.each(dados, function (index, value) {
                  html += '<tr><td class="sort text-center">' + value.nome_usuario + '</td><td class="sort text-center">' + value.total_prisao + '</td></tr>'; 
