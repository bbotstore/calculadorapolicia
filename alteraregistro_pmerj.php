            ...
            <div class="col-lg-6 col-7">
               ...
               <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                  <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                     ...
                     <li class="breadcrumb-item active" aria-current="page">Alterar Registros - Polícia Militar</li>
                  </ol>
               </nav>
            </div>
...
<script>
   ...
   $(".manipular_registros_pmerj").addClass("active");
   ...
   $.ajax({
          type: "POST",
          url: "php/banco.php?tab=bateponto&acao=lista_usuarios_pmerj",
          success: function (data) {
              if (data.resp == 'ok') {
                  html = '';
